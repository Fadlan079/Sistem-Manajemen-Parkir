...
<body class="bg-slate-900 min-h-screen p-6">
    ...
    <div class="max-w-md mx-auto bg-slate-800 p-6 rounded-xl shadow-lg mt-10">
        ...
        <form action="?action=store-tambah-user" method="POST" class="space-y-4">
            <div>
                <label class="block text-slate-300 mb-1" for="nama_lengkap">Nama Lengkap</label>
                <input type="text" name="nama_lengkap" id="nama_lengkap" class="w-full p-2 rounded bg-slate-900 text-slate-300" placeholder="Masukkan nama lengkap">
            </div>

            <div>
                <label class="block text-slate-300 mb-1" for="email">Email</label>
                <input type="email" name="email" id="email" class="w-full p-2 rounded bg-slate-900 text-slate-300" placeholder="Masukkan email">
            </div>

            <div>
                <label class="block text-slate-300 mb-1" for="password">Password</label>
                <input type="password" name="password" id="password" class="w-full p-2 rounded bg-slate-900 text-slate-300" placeholder="Masukkan password">
            </div>

            <div>
                <label class="block text-slate-300 mb-1" for="gender">Gender</label>
                <select name="gender" id="gender" class="w-full p-2 rounded bg-slate-900 text-slate-300">
