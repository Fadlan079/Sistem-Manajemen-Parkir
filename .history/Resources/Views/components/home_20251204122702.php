...
<?php if(!$sessionUser): ?>
<section class="min-h-screen bg-slate-900 text-white">
    ...
    <div class="text-center py-20 px-4">
        ...
        <p class="text-slate-300 max-w-xl mx-auto text-lg">
            Kelola kendaraan masuk & keluar dengan cepat, rapi, dan modern.
        </p>

        <a href="?action=login"
           class="mt-8 inline-block px-8 py-3 bg-cyan-500 hover:bg-cyan-600 
            text-slate-900 font-bold rounded-lg shadow">
            Login Untuk Mulai
        </a>
    </div>
    ...
    <!-- FITUR -->
    <div class="max-w-5xl mx-auto px-4 pb-20 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            ...
            <h3 class="text-lg font-bold text-white mb-2">Tiket Otomatis</h3>
            <p class="text-slate-400 text-sm">
                Generate tiket masuk lengkap dengan barcode siap cetak.
            </p>
        </div>

        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            <i class="fa-solid fa-barcode text-cyan-400 text-4xl mb-4"></i>
            <h3 class="text-lg font-bold text-white mb-2">Scan Keluar</h3>
            <p class="text-slate-400 text-sm">
                Proses keluar cepat cukup scan barcode dari tiket.
            </p>
        </div>

        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            <i class="fa-solid fa-credit-card text-cyan-400 text-4xl mb-4"></i>
            <h3 class="text-lg font-bold text-white mb-2">Hitung Tarif</h3>
            <p class="text-slate-400 text-sm">
                Sistem otomatis menghitung tarif berdasarkan durasi parkir.
            </p>
        </div>

        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            <i class="fa-solid fa-chart-line text-cyan-400 text-4xl mb-4"></i>
            <h3 class="text-lg font-bold text-white mb-2">Laporan Harian</h3>
            <p class="text-slate-400 text-sm">
                Rekap transaksi & total pendapatan secara otomatis.
            </p>
        </div>

        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            <i class="fa-solid fa-users-gear text-cyan-400 text-4xl mb-4"></i>
            <h3 class="text-lg font-bold text-white mb-2">Manajemen Petugas</h3>
            <p class="text-slate-400 text-sm">
                Admin dapat menambah & mengatur akun petugas.
            </p>
        </div>

        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center">
            <i class="fa-solid fa-database text-cyan-400 text-4xl mb-4"></i>
            <h3 class="text-lg font-bold text-white mb-2">Data Real-Time</h3>
            <p class="text-slate-400 text-sm">
                Pantau kendaraan masuk/keluar dengan akurat.
            </p>
        </div>
    </div>
