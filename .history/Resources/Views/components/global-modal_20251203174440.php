...
function alert($type, $message) {
    $styles = [
        'success' => 'bg-green-600/80 text-whitre border-green-600',
        'error'   => 'bg-red-600/80 text-red-400 border-red-600',
        'warning' => 'bg-yellow-600/80 text-yellow-400 border-yellow-600',
        'info'    => 'bg-blue-600/80 text-blue-400 border-blue-600',
    ];
