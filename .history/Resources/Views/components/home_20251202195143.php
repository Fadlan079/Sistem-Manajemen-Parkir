            ...
            <table class="min-w-full divide-y divide-slate-700">
                <thead class="bg-slate-900">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-medium text-slate-300">
                            <i class="fa-solid fa-motorcycle mr-1"></i> Jenis Kendaraan
                        </th>

                        <th class="px-4 py-2 text-left text-sm font-medium text-slate-300">
                            <i class="fa-solid fa-sign-in-alt mr-1"></i> Tgl Masuk
                        </th>

                        <th class="px-4 py-2 text-left text-sm font-medium text-slate-300">
                            <i class="fa-solid fa-sign-out-alt mr-1"></i> Tgl Keluar
                        </th>
...
$masuk  = fmt($tiket['tgl_masuk']);
$keluar = $tiket['tgl_keluar'] ? fmt($tiket['tgl_keluar']) : null;
?>
<td class="px-4 py-2 text-slate-300">
    <i class="fa-solid fa-door-open text-cyan-400"></i>
    <?= $masuk ?>
</td>

<td class="px-4 py-2 text-slate-300">
    <?php if($keluar): ?>
        <i class="fa-solid fa-door-closed text-emerald-400"></i>
        <?= $keluar ?>
    <?php else: ?>
