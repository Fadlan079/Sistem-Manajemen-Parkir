...
<td class="px-4 py-2 text-slate-300 text-center">
    ...
    $font = __DIR__ . '/fonts/RobotoMono-Regular.ttf'; // pastikan font ada
    $font = __DIR__ . '/fonts/RobotoMono-Regular.ttf'; // pastikan file ada
    $xPos = intval(($width - 7.2 * strlen($barcodeValue)) / 2);
    $yPos = $height + 15;

    imagettftext($newImg, 12, 0, $xPos, $yPos, $txtColor, $font, $barcodeValue);
