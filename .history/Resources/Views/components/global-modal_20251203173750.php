...
?>
    <div class="alert fixed top-10 left-1/2 transform -translate-x-1/2 p-4 mb-5 <?= $style ?> border rounded-lg flex items-center opacity-0 translate-y-[-20px] z-50" id="flashAlert">
