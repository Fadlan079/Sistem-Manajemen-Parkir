...
public function GetTiketByBarcode($barcode){
    ...
    public function InsertTiketMasuk($nomor_polisi,$jenis_kendaraan,$id_tarif,$tgl_masuk,$total_harga,$id_petugas_masuk,$status){
        try{
            ...
            $stmt->bindParam(":ttotal_harga",$total_harga);
