...
public function getTiketById($id)
{
    $sql = "SELECT 
                t.*, 
                p1.nama_lengkap AS nama_petugas_masuk,
                p2.nama_lengkap AS nama_petugas_keluar
            FROM tiket t
            LEFT JOIN petugas p1 ON p1.id_petugas = t.id_petugas_masuk
            LEFT JOIN petugas p2 ON p2.id_petugas = t.id_petugas_keluar
            WHERE t.id_tiket = :id
            LIMIT 1";
